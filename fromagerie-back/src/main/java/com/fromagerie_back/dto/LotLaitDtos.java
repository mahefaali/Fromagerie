...
public final class LotLaitDtos {
 private LotLaitDtos(){}
 public record Request(@NotBlank @Size(max=80) String numeroLot,@NotNull @PastOrPresent LocalDateTime dateTraite,@NotNull TypeTraite typeTraite,@NotNull @Positive BigDecimal quantite,@Size(max=4000) String observations){}
 public record Response(Long id,String numeroLot,LocalDateTime dateTraite,TypeTraite typeTraite,BigDecimal quantite,BigDecimal quantiteDisponible,String observations,List<AnalyseResponse> analyses){}
