        ...
        try {
            ...
            if (typeof window !== "undefined") {
                ...
                if (client) {
                    ...
                    client.userRole = submissionData.formData?.role ?? client.userRole;
                    if (submissionData.formData?.role === "Propriétaire") {
                        client.userName = "Fromager Admin";
                        client.userEmail = "proprietaire@fromagerie.art";
                    }
